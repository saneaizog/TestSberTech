...
- Система должно поддерживать горизонтальное масштабирование микросервисов для увеличения производительности (добавление новых узлов в кластер при увеличении нагрузки).
